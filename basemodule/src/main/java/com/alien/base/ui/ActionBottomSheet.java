...
public class ActionBottomSheet extends Fragment implements OnClickListener {
    ...
    private View createView() {
        ...
        if (hasNavigationBar(getActivity())) {
            navigationBarHeight = getNavigationBarHeight(getActivity());
        }
    ...
    public static class Builder {
        ...
        private String mTag = "ActionBottomSheet";
        ...
        public ActionBottomSheet show() {
            ActionBottomSheet actionSheet = (ActionBottomSheet) Fragment.instantiate(mContext, ActionBottomSheet.class.getName(), prepareArguments());
    ...
    public interface ActionSheetListener {
        void onDismiss(ActionBottomSheet actionSheet, boolean isCancel);
        void onOtherTextViewClick(ActionBottomSheet actionSheet, int index);
    }
